...
public class FAQTest extends BaseTest {
    ...
    @Parameterized.Parameters(name = "FAQ тест: вопрос #{0}")
    ...
    public void testFaqAccordion() {
        ...
        assertTrue("Ответ не соответствует ожидаемому для вопроса " + questionIndex +
                        ". Ожидали: " + expectedAnswer + ", но получили: " + actualAnswer,
